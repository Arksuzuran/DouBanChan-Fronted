...
export default {
    ...
    actions: {
        ...
        //获取我的话题的话题列表12
        getTopicListMineOnline(context, info) {
            return new Promise((resolve, reject) => {
                axios({
                    method: "post",
                    data: qs.stringify({
                    ...
                    url: "/user/get_self_chat/",
                    headers: { "content-type": "application/x-www-form-urlencoded" },
                })
                    .then((res) => {
                        console.log('成功获取我的话题列表',res);
        ...
        getTopicListByGroupIdOnline(context, info) {
            return new Promise((resolve, reject) => {
                axios({
                    ...
                    url: "/chat/query_chat_by_group/",
                    headers: { "content-type": "application/x-www-form-urlencoded" },
                })
                    .then((res) => {
                        resolve(res);
                        console.log('成功获取小组的话题',res);
                        context.commit("SET_TOPICLIST", res.data.chatList);
                    })
                    .catch((err) => {
                        reject(err);
        ...
        joinTopicOnline(context, info) {
            let url = info.is ? "/chat/join_chat/" : "/chat/quit_chat/";
            ...
            return new Promise((resolve, reject) => {
                axios({
                    ...
                    .then((res) => {
                        console.log(info.is ? "加入话题成功" : "退出话题成功", res);
                        resolve(res);
                    })
                    .catch((err) => {
                        reject(err);
