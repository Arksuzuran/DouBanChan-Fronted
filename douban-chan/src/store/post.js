...
export default {
    ...
    actions: {
        ...
        likePostOnline(context, info) {
            ...
            let url = info.is ? "/post/like_post/" : "/post/cancel_like_post/";
            return new Promise((resolve, reject) => {
                axios({
                    method: "post",
                    data: qs.stringify({
                    ...
                    .then((res) => {
                        console.log(info.is ? "点赞成功" : "取消点赞成功", res);
                        resolve(res);
                    })
                    .catch((err) => {
                        reject(err);
        ...
        dislikePostOnline(context, info) {
            ...
            let url = info.is ? "/post/dislike_post/" : "/post/cancel_dislike_post/";
            return new Promise((resolve, reject) => {
                axios({
                    method: "post",
                    data: qs.stringify({
                    ...
                    .then((res) => {
                        console.log(info.is ? "点踩成功" : "取消点踩成功", res);
                        resolve(res);
                    })
                    .catch((err) => {
                        reject(err);
        ...
        favPostOnline(context, info) {
            ...
            let url = info.is
                ? "/post/post_set_favorite/"
                : "/post/post_cancel_favorite/";
            return new Promise((resolve, reject) => {
                axios({
                    method: "post",
                    data: qs.stringify({
                    ...
                    .then((res) => {
                        console.log(info.is ? "收藏成功" : "取消收藏成功", res);
                        resolve(res);
                    })
                    .catch((err) => {
                        reject(err);
        ...
        topPostOnline(context, info) {
            let url = info.top ? "/post/set_top/" : "/post/cancel_top/";
            return new Promise((resolve, reject) => {
                axios({
                    method: "post",
                    data: qs.stringify({
        ...
        goodPostOnline(context, info) {
            let url = info.good ? "/post/set_essence/" : "/post/cancel_essence/";
            return new Promise((resolve, reject) => {
                axios({
                    method: "post",
                    data: qs.stringify({
        ...
        //举报帖子12
        reportPostOnline(context, info) {
            console.log("尝试举报帖子", info.textId);
            return new Promise((resolve, reject) => {
                axios({
                    method: "post",
                    data: qs.stringify({
                    ...
                    url: "/report/report_post/",
                    headers: { "content-type": "application/x-www-form-urlencoded" },
                })
                    .then((res) => {
                        console.log("举报帖子成功", res);
                        resolve(res);
                    })
                    .catch((err) => {
                        reject(err);
        ...
        reportTextOnline(context, info) {
            console.log("尝试举报文本", info.textId);
            // return new Promise((resolve, reject) => {
            //     axios({
            //         method: "post",
            //         data: qs.stringify({
            ...
            //             m_description: info.text
            //         }),
            //         url: '/report/report_text/',
            //         headers: { "content-type": "application/x-www-form-urlencoded" },
            //     })
            //         .then((res) => {
            //             console.log('举报文本成功',res);
            //             resolve(res);
            //         })
            //         .catch((err) => {
            //             reject(err);
