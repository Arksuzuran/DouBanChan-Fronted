    ...
    data() {
        return {
            ...
            menuItems: [
                ...
                { label: '电影', value: 'item2', index: "videoHome" },
                { label: '图书', value: 'item3', index: "bookHome" },
                { label: '小组', value: 'item4', index: "topicHome" },
                { label: '话题', value: 'item5', index: "groupHome" },
            ],
            menuValue: 'item1',
            restaurants: [],
            state: '',
            isLogin: false,
            circleUrl_not: "https://fuss10.elemecdn.com/e/5d/4a731a90594a4af544c0c25941171jpeg.jpeg",
