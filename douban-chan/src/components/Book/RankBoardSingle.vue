<template>
    ...
    <div class="rank-board" >
            ...
            <div class="videocard-heng">
                ...
                <div class="content">
                    ...
                    <div class="detail">
                        ...
                        作者：{{ items[0].m_author }}<br/>
                        出版社：{{ items[0].m_publisher }} <br/>
                    </div>
                </div>
                <div class="rate">
        ...
        <div class="nineWrapper">
            <div class="videocard-heng2" v-for="(item, index) in filteredItems" :key="index" @click="toBookDetail(item.m_id)">
                <div class="image">
