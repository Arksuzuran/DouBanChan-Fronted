...
body {
  background: #ffffff;
  /* background: linear-gradient(25deg, rgba(158, 145, 76, 1) 13%, rgba(156, 107, 57, 1) 28%, rgba(135, 105, 33, 1) 42%, rgba(136, 100, 12, 1) 58%, rgba(120, 43, 43, 1) 72%, rgba(112, 59, 59, 1) 85%); */
